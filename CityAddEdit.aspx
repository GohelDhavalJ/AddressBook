<%@ Page Title="" Language="C#" MasterPageFile="~/Content/AdminPanel.Master" AutoEventWireup="true" CodeBehind="CityAddEdit.aspx.cs" Inherits="AddressBook3Tire_Live.AdminPanel.CityAddEdit" %>
    ...
    <br />
     <div class="row">
        ...
        <div class="col-md-8">
            ...
            <asp:HyperLink runat="server" ID="btnCancel" Text="Cancel" CssClass="btn btn-danger btn-sm" NavigateUrl="~/Admin Panel/City/CityList.aspx" />
        </div>
    </div>
</asp:Content>
